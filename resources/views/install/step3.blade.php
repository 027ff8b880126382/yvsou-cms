...
<head>
  <title>yvsou-cms Installer - Step 3</title>
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css">
</head>

<body class="container py-5">
  <h2>Step 3: Cunstom Config</h2>

  <form method="POST" action="{{ route('install.saveCustomConfig') }}">
    @csrf
    ...
    <button type="submit">Create Cunstom Config</button>
  </form>
</body>
